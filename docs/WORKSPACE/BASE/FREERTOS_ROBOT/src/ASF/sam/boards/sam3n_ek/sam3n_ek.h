...
#define PIN_TC0_TIOB1_MUX     (IOPORT_MODE_MUX_B)
...
#define PIN_PWM_MOTORL_GPIO		PIO_PC18_IDX
#define PIN_PWM_MOTORL_FLAGS	(PIO_PERIPH_B | PIO_DEFAULT)
#define PIN_PWM_MOTORL_CHANNEL	PWM_CHANNEL_0		


#define PIN_PWM_MOTORR_GPIO		PIO_PC19_IDX
#define PIN_PWM_MOTORR_FLAGS	(PIO_PERIPH_B | PIO_DEFAULT)
#define PIN_PWM_MOTORR_CHANNEL	PWM_CHANNEL_1	


/* =============== PWM for SERVOS =============== */

#define PIN_PWM_SERVOH_GPIO		PIO_PC20_IDX
#define PIN_PWM_SERVOH_FLAGS	(PIO_PERIPH_B | PIO_DEFAULT)
#define PIN_PWM_SERVOH_CHANNEL	PWM_CHANNEL_2		


#define PIN_PWM_SERVOL_GPIO		PIO_PC21_IDX
#define PIN_PWM_SERVOL_FLAGS	(PIO_PERIPH_B | PIO_DEFAULT)
#define PIN_PWM_SERVOL_CHANNEL	PWM_CHANNEL_3	
